...
<html lang="zh" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.2.3, mkdocs-material-4.6.0">
        ...
        <title>safe-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![downloads][downloads-image]][downloads-url] [![javascript style guide][standard-image]][standard-url] - 我的笔记</title>
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#safe-buffer" tabindex="1" class="md-skip">
        跳转至
      </a>
...
<a href="https://gitee.com/ljzsdut/ljzsdut" title="前往 Github 仓库" class="md-source" data-md-source="">
  ...
  <li class="md-nav__item md-nav__item--active md-nav__item--nested">
      ...
      <input class="md-toggle md-nav__toggle" data-md-toggle="nav-7-5-2-13-40" type="checkbox" id="nav-7-5-2-13-40" checked>
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="safe-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![downloads][downloads-image]][downloads-url] [![javascript style guide][standard-image]][standard-url]" class="md-nav__link md-nav__link--active">
      safe-buffer [![travis][travis-image]][travis-url] [![npm][npm-image]][npm-url] [![downloads][downloads-image]][downloads-url] [![javascript style guide][standard-image]][standard-url]
    </a>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#safer_nodejs_buffer_api" class="md-nav__link">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferfromarray" class="md-nav__link">
    Class Method: Buffer.from(array)
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferfromarraybuffer_byteoffset_length" class="md-nav__link">
    Class Method: Buffer.from(arrayBuffer[, byteOffset[, length]])
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferfrombuffer" class="md-nav__link">
    Class Method: Buffer.from(buffer)
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferfromstr_encoding" class="md-nav__link">
    Class Method: Buffer.from(str[, encoding])
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferallocsize_fill_encoding" class="md-nav__link">
    Class Method: Buffer.alloc(size[, fill[, encoding]])
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferallocunsafesize" class="md-nav__link">
    Class Method: Buffer.allocUnsafe(size)
          ...
          <li class="md-nav__item">
  <a href="#class_method_bufferallocunsafeslowsize" class="md-nav__link">
    Class Method: Buffer.allocUnsafeSlow(size)
          ...
          <li class="md-nav__item">
  <a href="#all_the_rest" class="md-nav__link">
    All the Rest
  </a>
        ...
        <li class="md-nav__item">
  <a href="#related_links" class="md-nav__link">
    Related links
  </a>
        ...
        <li class="md-nav__item">
  <a href="#why_is_buffer_unsafe" class="md-nav__link">
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#remote_memory_disclosure" class="md-nav__link">
    Remote Memory Disclosure
          ...
          <li class="md-nav__item">
  <a href="#would_this_ever_be_a_problem_in_real_code" class="md-nav__link">
    Would this ever be a problem in real code?
          ...
          <li class="md-nav__item">
  <a href="#which_real-world_packages_were_vulnerable" class="md-nav__link">
  ...
  <a href="#ws" class="md-nav__link">
    ws
          ...
          <li class="md-nav__item">
  <a href="#whats_the_solution" class="md-nav__link">
    What's the solution?
  </a>
    ...
    <nav class="md-nav">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#a_new_api_bufferallocunsafenumber" class="md-nav__link">
    A new API: Buffer.allocUnsafe(number)
          ...
          <li class="md-nav__item">
  <a href="#how_do_we_fix_nodejs_core" class="md-nav__link">
    How do we fix node.js core?
          ...
          <li class="md-nav__item">
  <a href="#whats_the_real_long-term_fix" class="md-nav__link">
...
<div class="codehilite"><pre><span></span><code>npm install safe-buffer
</code></pre></div>
...
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">Buffer</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;safe-buffer&#39;</span><span class="p">).</span><span class="nx">Buffer</span>

<span class="c1">// Existing buffer code will continue to work without issues:</span>

<span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="s1">&#39;hey&#39;</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">)</span>
<span class="ow">new</span> <span class="nx">Buffer</span><span class="p">([</span><span class="mf">1</span><span class="p">,</span> <span class="mf">2</span><span class="p">,</span> <span class="mf">3</span><span class="p">],</span> <span class="s1">&#39;utf8&#39;</span><span class="p">)</span>
<span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="nx">obj</span><span class="p">)</span>
<span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="mf">16</span><span class="p">)</span> <span class="c1">// create an uninitialized buffer (potentially unsafe)</span>

<span class="c1">// But you can use these new explicit APIs to make clear what you want:</span>

<span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;hey&#39;</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">)</span> <span class="c1">// convert from many types to a Buffer</span>
...
<h3 id="class_method_bufferfromarray">Class Method: Buffer.from(array)<a class="headerlink" href="#class_method_bufferfromarray" title="Permanent link">¶</a></h3>
<!-- YAML
added: v3.0.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">([</span><span class="mh">0x62</span><span class="p">,</span><span class="mh">0x75</span><span class="p">,</span><span class="mh">0x66</span><span class="p">,</span><span class="mh">0x66</span><span class="p">,</span><span class="mh">0x65</span><span class="p">,</span><span class="mh">0x72</span><span class="p">]);</span>
...
<h3 id="class_method_bufferfromarraybuffer_byteoffset_length">Class Method: Buffer.from(arrayBuffer[, byteOffset[, length]])<a class="headerlink" href="#class_method_bufferfromarraybuffer_byteoffset_length" title="Permanent link">¶</a></h3>
<!-- YAML
added: v5.10.0
-->
...
TypedArray.</p>
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">arr</span> <span class="o">=</span> <span class="ow">new</span> <span class="nb">Uint16Array</span><span class="p">(</span><span class="mf">2</span><span class="p">);</span>
...
<span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="nx">arr</span><span class="p">.</span><span class="nx">buffer</span><span class="p">);</span> <span class="c1">// shares the memory with arr;</span>
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">ab</span> <span class="o">=</span> <span class="ow">new</span> <span class="nb">ArrayBuffer</span><span class="p">(</span><span class="mf">10</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="nx">ab</span><span class="p">,</span> <span class="mf">0</span><span class="p">,</span> <span class="mf">2</span><span class="p">);</span>
...
<h3 id="class_method_bufferfrombuffer">Class Method: Buffer.from(buffer)<a class="headerlink" href="#class_method_bufferfrombuffer" title="Permanent link">¶</a></h3>
<!-- YAML
added: v3.0.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf1</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;buffer&#39;</span><span class="p">);</span>
<span class="kd">const</span> <span class="nx">buf2</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="nx">buf1</span><span class="p">);</span>
...
<h3 id="class_method_bufferfromstr_encoding">Class Method: Buffer.from(str[, encoding])<a class="headerlink" href="#class_method_bufferfromstr_encoding" title="Permanent link">¶</a></h3>
<!-- YAML
added: v5.10.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf1</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;this is a tést&#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf1</span><span class="p">.</span><span class="nx">toString</span><span class="p">());</span>
...
<span class="kd">const</span> <span class="nx">buf2</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;7468697320697320612074c3a97374&#39;</span><span class="p">,</span> <span class="s1">&#39;hex&#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf2</span><span class="p">.</span><span class="nx">toString</span><span class="p">());</span>
  <span class="c1">// prints: this is a tést</span>
</code></pre></div>

<p>A <code>TypeError</code> will be thrown if <code>str</code> is not a string.</p>
<h3 id="class_method_bufferallocsize_fill_encoding">Class Method: Buffer.alloc(size[, fill[, encoding]])<a class="headerlink" href="#class_method_bufferallocsize_fill_encoding" title="Permanent link">¶</a></h3>
<!-- YAML
added: v5.10.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="mf">5</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf</span><span class="p">);</span>
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="mf">5</span><span class="p">,</span> <span class="s1">&#39;a&#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf</span><span class="p">);</span>
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="nx">alloc</span><span class="p">(</span><span class="mf">11</span><span class="p">,</span> <span class="s1">&#39;aGVsbG8gd29ybGQ=&#39;</span><span class="p">,</span> <span class="s1">&#39;base64&#39;</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf</span><span class="p">);</span>
...
<h3 id="class_method_bufferallocunsafesize">Class Method: Buffer.allocUnsafe(size)<a class="headerlink" href="#class_method_bufferallocunsafesize" title="Permanent link">¶</a></h3>
<!-- YAML
added: v5.10.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="kd">const</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="nx">allocUnsafe</span><span class="p">(</span><span class="mf">5</span><span class="p">);</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">buf</span><span class="p">);</span>
...
<h3 id="class_method_bufferallocunsafeslowsize">Class Method: Buffer.allocUnsafeSlow(size)<a class="headerlink" href="#class_method_bufferallocunsafeslowsize" title="Permanent link">¶</a></h3>
<!-- YAML
added: v5.10.0
-->
...
<div class="codehilite"><pre><span></span><code><span class="c1">// need to keep around a few small chunks of memory</span>
...
<p>A <code>TypeError</code> will be thrown if <code>size</code> is not a number.</p>
<h3 id="all_the_rest">All the Rest<a class="headerlink" href="#all_the_rest" title="Permanent link">¶</a></h3>
...
<h2 id="related_links">Related links<a class="headerlink" href="#related_links" title="Permanent link">¶</a></h2>
<ul>
...
<h2 id="why_is_buffer_unsafe">Why is <code>Buffer</code> unsafe?<a class="headerlink" href="#why_is_buffer_unsafe" title="Permanent link">¶</a></h2>
...
<div class="codehilite"><pre><span></span><code><span class="c1">// Convert UTF-8 strings to hex</span>
<span class="kd">function</span> <span class="nx">toHex</span> <span class="p">(</span><span class="nx">str</span><span class="p">)</span> <span class="p">{</span>
  <span class="k">return</span> <span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="nx">str</span><span class="p">).</span><span class="nx">toString</span><span class="p">(</span><span class="s1">&#39;hex&#39;</span><span class="p">)</span>
<span class="p">}</span>
</code></pre></div>

<p><strong><em>But what happens if <code>toHex</code> is called with a <code>Number</code> argument?</em></strong></p>
<h3 id="remote_memory_disclosure">Remote Memory Disclosure<a class="headerlink" href="#remote_memory_disclosure" title="Permanent link">¶</a></h3>
...
like this:</p>
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">buf</span> <span class="o">=</span> <span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="mf">16</span><span class="p">)</span>
...
<h3 id="would_this_ever_be_a_problem_in_real_code">Would this ever be a problem in real code?<a class="headerlink" href="#would_this_ever_be_a_problem_in_real_code" title="Permanent link">¶</a></h3>
...
hex:</p>
<div class="codehilite"><pre><span></span><code><span class="c1">// Take a JSON payload {str: &quot;some string&quot;} and convert it to hex</span>
<span class="kd">var</span> <span class="nx">server</span> <span class="o">=</span> <span class="nx">http</span><span class="p">.</span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span> <span class="p">(</span><span class="nx">req</span><span class="p">,</span> <span class="nx">res</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="nx">req</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;end&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
    <span class="kd">var</span> <span class="nx">body</span> <span class="o">=</span> <span class="nb">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">data</span><span class="p">)</span>
    <span class="nx">res</span><span class="p">.</span><span class="nx">end</span><span class="p">(</span><span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="nx">body</span><span class="p">.</span><span class="nx">str</span><span class="p">).</span><span class="nx">toString</span><span class="p">(</span><span class="s1">&#39;hex&#39;</span><span class="p">))</span>
  <span class="p">})</span>
<span class="p">})</span>
...
<h3 id="which_real-world_packages_were_vulnerable">Which real-world packages were vulnerable?<a class="headerlink" href="#which_real-world_packages_were_vulnerable" title="Permanent link">¶</a></h3>
<h4 id="bittorrent-dht"><a href="https://www.npmjs.com/package/bittorrent-dht"><code>bittorrent-dht</code></a><a class="headerlink" href="#bittorrent-dht" title="Permanent link">¶</a></h4>
...
<h4 id="ws"><a href="https://www.npmjs.com/package/ws"><code>ws</code></a><a class="headerlink" href="#ws" title="Permanent link">¶</a></h4>
...
<div class="codehilite"><pre><span></span><code><span class="nx">socket</span><span class="p">.</span><span class="nx">send</span><span class="p">(</span><span class="nx">number</span><span class="p">)</span>
...
<div class="codehilite"><pre><span></span><code><span class="nx">server</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;connection&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">socket</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">socket</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;message&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">(</span><span class="nx">message</span><span class="p">)</span> <span class="p">{</span>
    <span class="nx">message</span> <span class="o">=</span> <span class="nb">JSON</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">message</span><span class="p">)</span>
...
<h3 id="whats_the_solution">What's the solution?<a class="headerlink" href="#whats_the_solution" title="Permanent link">¶</a></h3>
...
<h4 id="a_new_api_bufferallocunsafenumber">A new API: <code>Buffer.allocUnsafe(number)</code><a class="headerlink" href="#a_new_api_bufferallocunsafenumber" title="Permanent link">¶</a></h4>
...
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">buf</span> <span class="o">=</span> <span class="nx">Buffer</span><span class="p">.</span><span class="nx">allocUnsafe</span><span class="p">(</span><span class="mf">16</span><span class="p">)</span> <span class="c1">// careful, uninitialized memory!</span>
...
<h3 id="how_do_we_fix_nodejs_core">How do we fix node.js core?<a class="headerlink" href="#how_do_we_fix_nodejs_core" title="Permanent link">¶</a></h3>
...
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">str</span> <span class="o">=</span> <span class="mf">16</span>
<span class="ow">new</span> <span class="nx">Buffer</span><span class="p">(</span><span class="nx">str</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">)</span>
</code></pre></div>
...
<h3 id="whats_the_real_long-term_fix">What's the real long-term fix?<a class="headerlink" href="#whats_the_real_long-term_fix" title="Permanent link">¶</a></h3>
...
<h2 id="credit">credit<a class="headerlink" href="#credit" title="Permanent link">¶</a></h2>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../readable-stream/GOVERNANCE/" title="GOVERNANCE" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../string_decoder/" title="string_decoder" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  下一页
