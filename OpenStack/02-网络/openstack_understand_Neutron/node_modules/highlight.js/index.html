...
<html lang="zh" class="no-js">
  <head>
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#highlightjs" tabindex="1" class="md-skip">
        跳转至
      </a>
...
<a href="https://gitee.com/ljzsdut/ljzsdut" title="前往 Github 仓库" class="md-source" data-md-source="">
  ...
  <li class="md-nav__item md-nav__item--active md-nav__item--nested">
      ...
      <input class="md-toggle md-nav__toggle" data-md-toggle="nav-7-5-2-13-19" type="checkbox" id="nav-7-5-2-13-19" checked>
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="Highlight.js" class="md-nav__link md-nav__link--active">
      Highlight.js
    </a>
...
<nav class="md-nav md-nav--secondary">
  ...
  <a href="#getting_started" class="md-nav__link">
    Getting Started
        ...
        <li class="md-nav__item">
  <a href="#custom_initialization" class="md-nav__link">
    Custom Initialization
        ...
        <li class="md-nav__item">
  <a href="#web_workers" class="md-nav__link">
    Web Workers
  </a>
        ...
        <li class="md-nav__item">
  <a href="#getting_the_library" class="md-nav__link">
    Getting the Library
  </a>
    ...
    Links
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <h1 id="highlightjs">Highlight.js<a class="headerlink" href="#highlightjs" title="Permanent link">¶</a></h1>
...
detection.</p>
<h2 id="getting_started">Getting Started<a class="headerlink" href="#getting_started" title="Permanent link">¶</a></h2>
...
<div class="codehilite"><pre><span></span><code><span class="p">&lt;</span><span class="nt">link</span> <span class="na">rel</span><span class="o">=</span><span class="s">&quot;stylesheet&quot;</span> <span class="na">href</span><span class="o">=</span><span class="s">&quot;/path/to/styles/default.css&quot;</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;/path/to/highlight.pack.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
...
<div class="codehilite"><pre><span></span><code><span class="p">&lt;</span><span class="nt">pre</span><span class="p">&gt;&lt;</span><span class="nt">code</span> <span class="na">class</span><span class="o">=</span><span class="s">&quot;html&quot;</span><span class="p">&gt;</span>...<span class="p">&lt;/</span><span class="nt">code</span><span class="p">&gt;&lt;/</span><span class="nt">pre</span><span class="p">&gt;</span>
</code></pre></div>
...
<div class="codehilite"><pre><span></span><code><span class="p">&lt;</span><span class="nt">pre</span><span class="p">&gt;&lt;</span><span class="nt">code</span> <span class="na">class</span><span class="o">=</span><span class="s">&quot;nohighlight&quot;</span><span class="p">&gt;</span>...<span class="p">&lt;/</span><span class="nt">code</span><span class="p">&gt;&lt;/</span><span class="nt">pre</span><span class="p">&gt;</span>
</code></pre></div>

<h2 id="custom_initialization">Custom Initialization<a class="headerlink" href="#custom_initialization" title="Permanent link">¶</a></h2>
...
jQuery:</p>
<div class="codehilite"><pre><span></span><code><span class="nx">$</span><span class="p">(</span><span class="nb">document</span><span class="p">).</span><span class="nx">ready</span><span class="p">(</span><span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
...
<div class="codehilite"><pre><span></span><code><span class="nx">hljs</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span><span class="nx">useBR</span><span class="o">:</span> <span class="kc">true</span><span class="p">});</span>
...
<h2 id="web_workers">Web Workers<a class="headerlink" href="#web_workers" title="Permanent link">¶</a></h2>
...
<div class="codehilite"><pre><span></span><code><span class="nx">addEventListener</span><span class="p">(</span><span class="s1">&#39;load&#39;</span><span class="p">,</span> <span class="kd">function</span><span class="p">()</span> <span class="p">{</span>
  <span class="kd">var</span> <span class="nx">code</span> <span class="o">=</span> <span class="nb">document</span><span class="p">.</span><span class="nx">querySelector</span><span class="p">(</span><span class="s1">&#39;#code&#39;</span><span class="p">);</span>
  ...
  <span class="nx">worker</span><span class="p">.</span><span class="nx">onmessage</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span> <span class="p">{</span> <span class="nx">code</span><span class="p">.</span><span class="nx">innerHTML</span> <span class="o">=</span> <span class="nx">event</span><span class="p">.</span><span class="nx">data</span><span class="p">;</span> <span class="p">}</span>
...
<p>In worker.js:</p>
<div class="codehilite"><pre><span></span><code><span class="nx">onmessage</span> <span class="o">=</span> <span class="kd">function</span><span class="p">(</span><span class="nx">event</span><span class="p">)</span> <span class="p">{</span>
  <span class="nx">importScripts</span><span class="p">(</span><span class="s1">&#39;&lt;path&gt;/highlight.pack.js&#39;</span><span class="p">);</span>
  <span class="kd">var</span> <span class="nx">result</span> <span class="o">=</span> <span class="nx">self</span><span class="p">.</span><span class="nx">hljs</span><span class="p">.</span><span class="nx">highlightAuto</span><span class="p">(</span><span class="nx">event</span><span class="p">.</span><span class="nx">data</span><span class="p">);</span>
...
<h2 id="getting_the_library">Getting the Library<a class="headerlink" href="#getting_the_library" title="Permanent link">¶</a></h2>
...
<div class="codehilite"><pre><span></span><code><span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;//cdnjs.cloudflare.com/ajax/libs/highlight.js/9.4.0/languages/go.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</code></pre></div>

<p><strong>On Almond.</strong> You need to use the optimizer to give the module a name. For
example:</p>
<div class="codehilite"><pre><span></span><code>r.js -o name=hljs paths.hljs=/path/to/highlight out=highlight.js
</code></pre></div>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../gitbook-plugin-search-pro/" title="Index" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../html-entities/" title="Index" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  下一页
