...
<html lang="zh" class="no-js">
  <head>
    ...
    <label class="md-overlay" data-md-component="overlay" for="__drawer"></label>
      ...
      <a href="#chapter_fold_for_gitbook" tabindex="1" class="md-skip">
        跳转至
      </a>
...
<a href="https://gitee.com/ljzsdut/ljzsdut" title="前往 Github 仓库" class="md-source" data-md-source="">
  ...
  <li class="md-nav__item md-nav__item--active md-nav__item--nested">
      ...
      <input class="md-toggle md-nav__toggle" data-md-toggle="nav-7-5-2-13-10" type="checkbox" id="nav-7-5-2-13-10" checked>
...
<nav class="md-nav md-nav--secondary">
    ...
    <ul class="md-nav__list" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#anything_change" class="md-nav__link">
    Anything Change?
  </a>
        ...
        <li class="md-nav__item">
  <a href="#how_to_use_it" class="md-nav__link">
    How to use it?
  </a>
    ...
    Configuration
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <h1 id="chapter_fold_for_gitbook">Chapter fold for GitBook<a class="headerlink" href="#chapter_fold_for_gitbook" title="Permanent link">¶</a></h1>
<p>==============</p>
<p>Extended from the <strong>expandable-chapters</strong> plugin, and make a little modify. Thx for the original author.<br />
Tiny change to the expandable-chapters plugin from https://github.com/DomainDrivenArchitecture/ to use smaller arrows.  </p>
<h3 id="anything_change">Anything Change?<a class="headerlink" href="#anything_change" title="Permanent link">¶</a></h3>
<p>Modify the feature of the chapter links, make the links could be clicked to fold or expand their content.<br />
And add a new feature in order to keep the last chapter which the user browses at last time.  </p>
<h3 id="how_to_use_it">How to use it?<a class="headerlink" href="#how_to_use_it" title="Permanent link">¶</a></h3>
<p>Add it to your <code>book.json</code> configuration:</p>
...
<div class="codehilite"><pre><span></span><code>$ gitbook install
</code></pre></div>

<h3 id="configuration">Configuration<a class="headerlink" href="#configuration" title="Permanent link">¶</a></h3>
<p>There is <em>no</em> configuration needed at the moment, can be left empty.</p>
<div class="codehilite"><pre><span></span><code>{
    &quot;pluginsConfig&quot;: {
        &quot;chapter-fold&quot;:{}
    }
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../gitbook-plugin-back-to-top-button/" title="Gitbook Back to Top Button Plugin [![npm version](https://badge.fury.io/js/gitbook-plugin-back-to-top-button.svg)](https://badge.fury.io/js/gitbook-plugin-back-to-top-button)" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../gitbook-plugin-code/" title="Code plugin for GitBook" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  下一页
