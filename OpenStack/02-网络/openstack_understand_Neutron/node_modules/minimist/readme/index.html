...
<a href="https://gitee.com/ljzsdut/ljzsdut" title="前往 Github 仓库" class="md-source" data-md-source="">
  ...
  <li class="md-nav__item md-nav__item--active md-nav__item--nested">
      ...
      <input class="md-toggle md-nav__toggle" data-md-toggle="nav-7-5-2-13-35" type="checkbox" id="nav-7-5-2-13-35" checked>
  ...
  <li class="md-nav__item md-nav__item--active">
    ...
    <a href="./" title="minimist" class="md-nav__link md-nav__link--active">
      minimist
    </a>
...
<nav class="md-nav md-nav--secondary">
          ...
          <div class="md-content">
            <article class="md-content__inner md-typeset">
                ...
                <h1 id="minimist">minimist<a class="headerlink" href="#minimist" title="Permanent link">¶</a></h1>
...
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">argv</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minimist&#39;</span><span class="p">)(</span><span class="nx">process</span><span class="p">.</span><span class="nx">argv</span><span class="p">.</span><span class="nx">slice</span><span class="p">(</span><span class="mf">2</span><span class="p">));</span>
...
<div class="codehilite"><pre><span></span><code>$ node example/parse.js -a beep -b boop
{ _: [], a: &#39;beep&#39;, b: &#39;boop&#39; }
</code></pre></div>

<div class="codehilite"><pre><span></span><code>$ node example/parse.js -x 3 -y 4 -n5 -abc --beep=boop foo bar baz
{ _: [ &#39;foo&#39;, &#39;bar&#39;, &#39;baz&#39; ],
  x: 3,
  y: 4,
  n: 5,
...
<div class="codehilite"><pre><span></span><code><span class="kd">var</span> <span class="nx">parseArgs</span> <span class="o">=</span> <span class="nx">require</span><span class="p">(</span><span class="s1">&#39;minimist&#39;</span><span class="p">)</span>
</code></pre></div>

<h2 id="var_argv_parseargsargs_opts">var argv = parseArgs(args, opts={})<a class="headerlink" href="#var_argv_parseargsargs_opts" title="Permanent link">¶</a></h2>
...
<div class="codehilite"><pre><span></span><code>npm install minimist
</code></pre></div>
...
<footer class="md-footer">
    ...
    <div class="md-footer-nav">
      <nav class="md-footer-nav__inner md-grid">
          ...
          <a href="../../lodash.some/" title="lodash.some v4.6.0" class="md-flex md-footer-nav__link md-footer-nav__link--prev" rel="prev">
            <div class="md-flex__cell md-flex__cell--shrink">
          ...
          <a href="../../mkdirp/readme/" title="mkdirp" class="md-flex md-footer-nav__link md-footer-nav__link--next" rel="next">
            <div class="md-flex__cell md-flex__cell--stretch md-footer-nav__title">
              <span class="md-flex__ellipsis">
                <span class="md-footer-nav__direction">
                  下一页
